 ...
 *
 * MeshThreading = MultiThread(2)
 * CastThreading = MultiThread(2)
 *
 * The two threading axes are independent.  This example uses two mesh branches
...
int main() {
    constexpr std::size_t MeshThreads = 2;
    constexpr std::size_t WorkerThreads = 2;

    std::cout << "HighVoronoi combined parallel example\n";
