...
/** Legacy mapping tag for meshes still using virtual mapping hooks. */
template <class IndexT>
class VirtualIndexMapping {
public:
    using Index = IndexT;
    static constexpr bool uses_virtual_dispatch = true;
};
...
public:
    using Index = IndexT;
    static constexpr bool uses_virtual_dispatch = false;
